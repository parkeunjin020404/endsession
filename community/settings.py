...
ALLOWED_HOSTS = ['13.211.66.39','meotsajjang.shop','127.0.0.1']
...
INSTALLED_APPS = [
    ...
    'django.contrib.sites',  # 이 줄이 필수입니다
    'allauth.socialaccount',
    # 사용하는 소셜 계정 제공자 추가
    'allauth.socialaccount.providers.google',  # 예: 구글
]
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=99), # 이 부분
